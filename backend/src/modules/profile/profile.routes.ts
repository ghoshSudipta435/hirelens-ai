...
import { profileUpdateBodySchema, profileUserIdParamsSchema, profileAvatarUpdateSchema } from './profile.schemas';
...
profileRouter.patch('/avatar', authenticateAccessToken, validateRequest({ body: profileAvatarUpdateSchema }), profileController.updateAvatar);
profileRouter.get(
  '/:userId',
